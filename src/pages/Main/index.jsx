...
import DefaultBtn from "../../components/Buttons/DefaultBtn/index";
      ...
      <MainBlockWrapper>
        ...
        <MainInfoContainer>
          <InfoWrapper>
            ...
            <DefaultBtn name="Записаться" path={APPOINTMENT_ROUTE} />
          </InfoWrapper>
          <NextBtn
            Svg={({
              onTouchEnd,
      ...
      <BlockWrapper id="Section-1">
        <ContainerInfo>
          <InfoWrapper left>
            ...
            <DefaultBtn name="Посмотреть" path={COURSES_ROUTE} />
            <NextBtn
              Svg={({
                onTouchEnd,
                onTouchStart,
